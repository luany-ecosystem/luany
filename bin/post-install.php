...
echo "    Configure database    →  \033[36m.env\033[0m\n";
echo "    Check environment     →  \033[36mluany doctor\033[0m\n";
echo "    Run migrations        →  \033[36mluany migrate\033[0m\n";
echo "    Start dev server      →  \033[36mluany serve\033[0m\n";
echo "\n";